...
lula_gray = cv2.imread("./data/test.jpg",0)
lula = cv2.cvtColor(cv2.imread("./data/test.jpg",1),cv2.COLOR_BGR2RGB)
lula_noise = cv2.cvtColor(cv2.imread("./data/sp_noise_img.jpg"),cv2.COLOR_BGR2RGB)
